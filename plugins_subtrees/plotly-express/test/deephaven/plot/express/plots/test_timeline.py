...
class TimelineTestCase(BaseTestCase):
    def setUp(self) -> None:
        ...
        self.source = new_table([
            datetime_col("Start", [start, start, start, start, start, start, start, start, start]),
    ...
    def test_basic_timeline(self):
        ...
        chart = dx.timeline(self.source, x_start="Start", x_end="End", y="Category").to_dict(self.exporter)
