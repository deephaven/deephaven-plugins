...
class MakeSubplotsTestCase(BaseTestCase):
    ...
    def test_make_subplots_use_existing_titles_with_grid(self):
        import src.deephaven.plot.express as dx
