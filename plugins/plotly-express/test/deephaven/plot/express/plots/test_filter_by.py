...
DEFAULT_PLOTLY_TRACE = {'hovertemplate': 'x=%{x}<br>y=%{y}<extra></extra>',
                        'legendgroup': '',
...
DEFAULT_PLOTLY_LAYOUT = {'legend': {'tracegroupgap': 0},
                         'margin': {'t': 60},
                         'xaxis': {'anchor': 'y',
                                   'domain': [0.0, 1.0],
                                   'title': {'text': 'x'}},
...
class FilterByTestCase(BaseTestCase):
    ...
    def test_filter(self):
        ...
        expected_filter_columns = {'columns': [
            {'name': 'cat_one',
             'required': False,
        ...
        expected_data = [{'hovertemplate': 'cat_one=A<br>X=%{x}<br>Y=%{y}<extra></extra>',
                          'legendgroup': 'A',
        ...
        expected_mappings = [{'data_columns': {'X': ['/plotly/data/0/x'],
                                               'Y': ['/plotly/data/0/y']},
                              'table': 0},
                             {'data_columns': {'X': ['/plotly/data/1/x'],
                                               'Y': ['/plotly/data/1/y']},
                              'table': 0}]
    ...
    def test_filters(self):
        ...
        expected_data = [{'hovertemplate': 'cat_one=A<br>cat_two=C<br>X=%{x}<br>Y=%{y}<extra></extra>',
                          'legendgroup': 'A, C',
                          'line': {'color': '#636efa', 'dash': 'solid', 'shape': 'linear'},
                          'marker': {'symbol': 'circle'},
                          'mode': 'lines',
        ...
        expected_mappings = [{'data_columns': {'X': ['/plotly/data/0/x'], 'Y': ['/plotly/data/0/y']},
                              'table': 0},
    ...
    def test_required_filter(self):
        ...
        expected_filter_columns = {'columns': [{'name': 'cat_one', 'required': True, 'type': 'java.lang.String'}]}
    ...
    def test_required_filters(self):
        ...
        expected_filter_columns = {'columns': [{'name': 'cat_two', 'required': True, 'type': 'java.lang.String'},
    ...
    def test_mixed_filters(self):
        ...
        expected_data = [{'hovertemplate': 'x=%{x}<br>y=%{y}<extra></extra>',
                          'legendgroup': '',
                          'marker': {'color': '#636efa', 'symbol': 'circle'},
                          'mode': 'markers',
                          'name': '',
    ...
    def test_filter_plot_by(self):
        ...
        expected_filter_columns = {'columns': [{'name': 'cat_two',
                                                'required': False,
                                                'type': 'java.lang.String'}]}
    ...
    def test_partitioned_filter(self):
        ...
        expected_filter_columns = {'columns': [{'name': 'cat_two', 'required': False, 'type': 'java.lang.String'},
                                               {'name': 'cat_one',
                                                'required': False,
                                                'type': 'java.lang.String'}]}
    ...
    def test_subplot_same_filter(self):
        ...
        expected_mappings = [{'data_columns': {'X': ['/plotly/data/1/x'], 'Y': ['/plotly/data/1/y']},
                              'table': 0},
    ...
    def test_subplot_different_filter(self):
        ...
        expected_data = [DEFAULT_PLOTLY_TRACE,
                         {'hovertemplate': 'cat_one=A<br>X=%{x}<br>Y=%{y}<extra></extra>',
                          'legendgroup': 'A',
                          'line': {'color': '#636efa', 'dash': 'solid', 'shape': 'linear'},
                          'marker': {'symbol': 'circle'},
        ...
        expected_data = [{'hovertemplate': 'cat_two=C<br>X=%{x}<br>Y=%{y}<extra></extra>',
                          'legendgroup': 'C',
                          'line': {'color': '#636efa', 'dash': 'solid', 'shape': 'linear'},
                          'marker': {'symbol': 'circle'},
                          'mode': 'lines',
