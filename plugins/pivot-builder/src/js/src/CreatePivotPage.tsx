...
export function CreatePivotPage({
  ...
  const columnTypes = useMemo(() => {
    // Null-prototype: consumers do plain `columnTypes[name]` lookups to test
    // column existence, which would otherwise resolve to inherited
    // Object.prototype members (e.g. a column named `constructor`) instead of
    // `undefined`.
