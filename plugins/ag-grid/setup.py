...
if os.path.exists(dist_dir):
    ...
    # move the contents of the package directory to the ag-grid directory
...
setup(package_data={"js.ag-grid": ["**"]})

# ignore errors as the directory may not exist
shutil.rmtree("src/js/ag-grid", ignore_errors=True)
