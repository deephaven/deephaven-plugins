...
def search_field(
    ...
    type: TextFieldType | None = "search",
    ...
    Args:
        ...
        pattern: A regular expression that the input's value must match to be valid.
        type: The type of input to display (defaults to "search").
        input_mode: Hints at the type of data that might be entered by the user while editing the element or its contents.
        ...
        on_clear: Function called when the clear button is pressed.
        on_submit: Function called when the search is submitted.
        ...
        aria_auto_complete: Indicates whether inputting text could trigger display of one or more predictions of the user's intended value.
        aria_haspopup: Indicates whether the element has a popup.
    ...
    Returns:
        The rendered search field element.
    """
