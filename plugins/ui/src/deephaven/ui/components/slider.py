...
def slider(
    is_filled: bool | UndefinedType = Undefined,
    fill_offset: float | UndefinedType = Undefined,
    track_gradient: list[str] | UndefinedType = Undefined,
    ...
    on_change_end: Callable[[float], None] | UndefinedType = Undefined,
