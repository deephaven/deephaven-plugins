...
def button(
    *children: Any,
    variant: ButtonVariant | UndefinedType = "accent",
    style: ButtonStyle | UndefinedType = "fill",
    static_color: StaticColor | UndefinedType = Undefined,
    is_pending: bool | UndefinedType = Undefined,
    type: ButtonType = "button",
    is_disabled: bool | UndefinedType = Undefined,
    auto_focus: bool | UndefinedType = Undefined,
    href: str | UndefinedType = Undefined,
    target: str | UndefinedType = Undefined,
    rel: str | UndefinedType = Undefined,
    ...
    aria_has_popup: AriaHasPopup | UndefinedType = Undefined,
