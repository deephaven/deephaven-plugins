...
def number_field(
    ...
    hide_stepper: bool | UndefinedType = Undefined,
    decrement_aria_label: str | UndefinedType = Undefined,
    increment_aria_label: str | UndefinedType = Undefined,
    is_wheel_disabled: bool | UndefinedType = Undefined,
    format_options: NumberFieldFormatOptions | UndefinedType = Undefined,
    ...
    default_value: float | UndefinedType = Undefined,
    min_value: float | UndefinedType = Undefined,
    max_value: float | UndefinedType = Undefined,
    ...
    validation_state: TextFieldValidationState | UndefinedType = Undefined,
    ...
    on_change: Callable[[float], None] | UndefinedType = Undefined,
