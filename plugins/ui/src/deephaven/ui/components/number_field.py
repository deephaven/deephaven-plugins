...
def number_field(
    ...
    hide_stepper: bool | Undefined = UNDEFINED,
    decrement_aria_label: str | Undefined = UNDEFINED,
    increment_aria_label: str | Undefined = UNDEFINED,
    is_wheel_disabled: bool | Undefined = UNDEFINED,
    format_options: NumberFieldFormatOptions | Undefined = UNDEFINED,
    ...
    min_value: float | Undefined = UNDEFINED,
    max_value: float | Undefined = UNDEFINED,
    ...
    validation_state: TextFieldValidationState | Undefined = UNDEFINED,
