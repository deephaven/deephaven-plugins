...
def view(
    *children: Any,
    element_type: ElementTypes | UndefinedType = Undefined,
    ...
    padding: DimensionValue | UndefinedType = Undefined,
    ...
    border_width: BorderSize | UndefinedType = Undefined,
    border_start_width: BorderSize | UndefinedType = Undefined,
    border_end_width: BorderSize | UndefinedType = Undefined,
    border_top_width: BorderSize | UndefinedType = Undefined,
    border_bottom_width: BorderSize | UndefinedType = Undefined,
    border_x_width: BorderSize | UndefinedType = Undefined,
    border_y_width: BorderSize | UndefinedType = Undefined,
    border_color: Color | UndefinedType = Undefined,
    border_start_color: Color | UndefinedType = Undefined,
    border_end_color: Color | UndefinedType = Undefined,
    border_top_color: Color | UndefinedType = Undefined,
    border_bottom_color: Color | UndefinedType = Undefined,
    border_x_color: Color | UndefinedType = Undefined,
    border_y_color: Color | UndefinedType = Undefined,
    border_radius: BorderRadius | UndefinedType = Undefined,
    border_top_start_radius: BorderRadius | UndefinedType = Undefined,
    border_top_end_radius: BorderRadius | UndefinedType = Undefined,
    border_bottom_start_radius: BorderRadius | UndefinedType = Undefined,
    border_bottom_end_radius: BorderRadius | UndefinedType = Undefined,
