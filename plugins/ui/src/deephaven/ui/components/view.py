...
def view(
    *children: Any,
    element_type: ElementTypes | Undefined = UNDEFINED,
    ...
    padding: DimensionValue | Undefined = UNDEFINED,
    ...
    border_width: BorderSize | Undefined = UNDEFINED,
    border_start_width: BorderSize | Undefined = UNDEFINED,
    border_end_width: BorderSize | Undefined = UNDEFINED,
    border_top_width: BorderSize | Undefined = UNDEFINED,
    border_bottom_width: BorderSize | Undefined = UNDEFINED,
    border_x_width: BorderSize | Undefined = UNDEFINED,
    border_y_width: BorderSize | Undefined = UNDEFINED,
    border_color: Color | Undefined = UNDEFINED,
    border_start_color: Color | Undefined = UNDEFINED,
    border_end_color: Color | Undefined = UNDEFINED,
    border_top_color: Color | Undefined = UNDEFINED,
    border_bottom_color: Color | Undefined = UNDEFINED,
    border_x_color: Color | Undefined = UNDEFINED,
    border_y_color: Color | Undefined = UNDEFINED,
    border_radius: BorderRadius | Undefined = UNDEFINED,
    border_top_start_radius: BorderRadius | Undefined = UNDEFINED,
    border_top_end_radius: BorderRadius | Undefined = UNDEFINED,
    border_bottom_start_radius: BorderRadius | Undefined = UNDEFINED,
    border_bottom_end_radius: BorderRadius | Undefined = UNDEFINED,
