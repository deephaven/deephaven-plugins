...
def range_slider(
    ...
    max_value: float = 100,
    step: float = 1,
    value: SliderChange | Undefined = UNDEFINED,
    default_value: SliderChange | Undefined = UNDEFINED,
    label: Any | Undefined = UNDEFINED,
    name: str | Undefined = UNDEFINED,
    on_change_end: SliderChangeCallable | Undefined = UNDEFINED,
    on_change: SliderChangeCallable | Undefined = UNDEFINED,
