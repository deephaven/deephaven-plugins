...
def text_field(
    ...
    type: TextFieldType | UndefinedType = Undefined,
    input_mode: TextFieldInputMode | UndefinedType = Undefined,
    ...
    aria_active_descendant: str | UndefinedType = Undefined,
    aria_auto_complete: AriaAutoComplete | UndefinedType = Undefined,
