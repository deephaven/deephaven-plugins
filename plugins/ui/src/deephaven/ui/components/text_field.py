...
def text_field(
    ...
    max_length: int | Undefined = UNDEFINED,
    min_length: int | Undefined = UNDEFINED,
    pattern: str | Undefined = UNDEFINED,
    type: TextFieldType | Undefined = UNDEFINED,
    input_mode: TextFieldInputMode | Undefined = UNDEFINED,
    ...
    aria_active_descendant: str | Undefined = UNDEFINED,
    aria_auto_complete: AriaAutoComplete | Undefined = UNDEFINED,
