...
def button(
    *children: Any,
    ...
    rel: str | None = None,
    # element_type, # do I have to make a class for every possible ElementType?
    ...
    return spectrum_element(
        ...
        *children,
        ...
        rel=rel,
        onPress=on_press,
        onPressStart=on_press_start,
        onPressEnd=on_press_end,
        onPressUp=on_press_up,
        onPressChange=on_press_change,
        onFocus=on_focus,
        onBlur=on_blur,
        ...
        isHidden=is_hidden,
        id=id,
        excludeFromTabOrder=exclude_from_tab_order,
        ariaExpanded=aria_expanded,
        ariaHasPopup=aria_has_popup,
        ariaControls=aria_controls,
        ariaPressed=aria_pressed,
        ariaLabel=aria_label,
        ariaLabelledBy=aria_labelled_by,
        ariaDescribedBy=aria_described_by,
        ariaDetails=aria_details,
        UNSAFE_className=UNSAFE_class_name,
