...
from ..types import Time, TimeGranularity, Undefined, UNDEFINED
...
@make_component
def time_field(
    placeholder_value: Time | Undefined = UNDEFINED,
    value: Time | Undefined = UNDEFINED,
    ...
    on_change: Callable[[Time], None] | Undefined = UNDEFINED,
