...
from ..types import Key, Selection, UndefinedType, Undefined
...
def checkbox_group(
    *children: Any,
    ...
    value: Selection | UndefinedType = Undefined,
    default_value: Selection | UndefinedType = Undefined,
    ...
    label_position: str | UndefinedType = Undefined,
    label_align: str | UndefinedType = Undefined,
    necessity_indicator: str | UndefinedType = Undefined,
