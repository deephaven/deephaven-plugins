...
class DatePickerTest(BaseTestCase):
    def test_convert_date_props(self):
        ...
        from deephaven.ui.components.date_field import _convert_date_field_props
        ...
        _convert_date_field_props(props2)
        props2["unavailable_dates"] = convert_list_prop(
            "unavailable_dates", props2["unavailable_dates"]
        )
        _convert_date_field_props(props3)
        _convert_date_field_props(props4)
        _convert_date_field_props(props5)
        _convert_date_field_props(props6)
