...
class CalendarTest(BaseTestCase):
    def test_convert_date_props(self):
        ...
        from deephaven.ui.components.range_calendar import _convert_range_calendar_props
        ...
        _convert_range_calendar_props(props1)
        _convert_range_calendar_props(props2)
        _convert_range_calendar_props(props3)
        _convert_range_calendar_props(props4)
        _convert_range_calendar_props(props5)
        _convert_range_calendar_props(props6)
