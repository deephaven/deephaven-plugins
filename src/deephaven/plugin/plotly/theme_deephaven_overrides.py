...
pio.templates["deephaven_overrides"] = go.layout.Template(
    layout = {
        ...
        'polar': {'angularaxis': {'gridcolor': grid_color, 'linecolor': line_color},
                  'bgcolor': bg_color,
                  'radialaxis': {'gridcolor': grid_color, 'linecolor': line_color}},
        'scene': {'xaxis': {'zerolinecolor': zeroline_color,
                  ...
                  'yaxis': {'zerolinecolor': zeroline_color,
                            'zerolinewidth': 2,
                            'gridcolor': grid_color,
                            'linecolor': line_color,
                            'showline': True,
                  ...
                  'zaxis': {'zerolinecolor': zeroline_color,
                            'gridcolor':grid_color,
                            'linecolor': line_color,
                            'showline': True,
                            'title': {
